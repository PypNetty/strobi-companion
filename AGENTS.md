...
The Windows desktop companion lives in `companion/`. It is a separate Tauri 2 app that consumes the
existing avatar engine. Do not fold Studio UI, persistence, or export flows into that app.
