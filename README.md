...
The Windows companion is a separate Tauri app in `companion/`. It reuses the procedural avatar engine without the Studio UI.
...
| `pnpm companion:dev`   | Start the separate Tauri desktop companion.                                       |
| `pnpm companion:test`  | Run companion behavior and gaze tests (no camera required).                       |
